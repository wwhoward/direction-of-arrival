...
clc,clear,close all
addpath('data', 'Helper', 'functions', 'runtype', 'Helper/mtimesx', 'Helper/Eig3Folder'); 
...
par.snrSweep = -10:2:10;       % Variable SNR for runtypes other than 'single'

% Estimation & Statistics
par.res = 2^7 / pi;         % Resolution for MUSIC-type estimators
...
par.saveName = "2d_test";  % Appends this to the name for ease of identification (edited later to be unique)
